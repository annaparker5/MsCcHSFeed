...
```{r}
datalong5$treatment <- factor(datalong5$treatment, labels = c("Nonparasitized baseline", "Nonparasitized heat shocked", "Parasitized baseline", "Parasitized heat shocked"))
