...
# Table 1: Mean percent eclosion success
...
#dataviolin <- dataviolin[dataviolin$food != "", ]
...
ggsave("~/Desktop/GitHub/MsCcHSFeed/Figs/violins3.png", violins, width = 8, height = 5)
...
```{r}
datadead$treatment <- factor(data$treatment, levels = c("NP NHS", "NP HS", "P NHS", "P HS"))
...
Multinomial regression from Katherine to report proportions of outcomes in PHS treatment group
